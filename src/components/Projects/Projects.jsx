...
// Projects to ignore/remove from the list
const IGNORED_PROJECTS = ['Karthigaiselvam-dev', 'Karthigaiselvam-R-official', 'Calculator_Using_QML_Cpp', 'Vulnerability_Scanner']
...
const FALLBACK_REPOS = [
    {
        ...
        forks_count: 12,
        language: 'Python',
        customDescription: projectDescriptions['AsusTufFanControl_Linux'],
        images: [projectImages['AsusTufFanControl_Linux']]
    },
    {
        id: 'fallback-2',
        name: '403-bypass3r',
        ...
        forks_count: 8,
        language: 'Shell',
        customDescription: projectDescriptions['403-bypass3r'],
        images: [projectImages['403-bypass3r']]
    },
    {
        id: 'fallback-3',
        ...
        forks_count: 5,
        language: 'Python',
        customDescription: projectDescriptions['Smart_Attendance'],
        images: [projectImages['Smart_Attendance']]
    }
]
    ...
    useEffect(() => {
        ...
        const fetchRepos = async () => {
            try {
                ...
                // Filter out forks and ignored projects
                const filteredRepos = allRepos.filter(repo => !repo.fork && !IGNORED_PROJECTS.includes(repo.name))
                ...
                console.error('Error fetching repos, using fallback data:', err)
                setRepos(FALLBACK_REPOS)
                setError(null) // hide error since we are using fallback data
            } finally {
                setLoading(false)
            }
        }
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <p className="section-subtitle">
                            Security tools and applications - {repos === FALLBACK_REPOS ? 'offline cache' : 'fetched live from GitHub'}
                            {loading && <Loader />}
                        </p>
                    </motion.div>
                </div>
